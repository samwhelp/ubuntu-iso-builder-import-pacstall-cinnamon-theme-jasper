...
REF_WORK_DIR_PATH="${HOME}/work/ubuntu-iso-builder-import-pacstall-cinnamon-theme-jasper"
...
echo "[Next Step]: cd ~/work/ubuntu-iso-builder-import-pacstall-cinnamon-theme-jasper/iso-profile
"
echo
